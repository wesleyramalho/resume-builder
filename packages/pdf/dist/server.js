...
// src/lib/schemas.ts
import { z } from "zod";
var optionalEmail = z.string().max(255, "tooLong").refine((val) => val === "" || /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(val), {
  message: "invalidEmail"
});
var optionalUrl = z.string().max(200, "tooLong").refine(
...
var experienceEntrySchema = z.object({
  ...
  current: z.boolean(),
  description: z.string().max(3e3, "tooLong")
});
var educationEntrySchema = z.object({
  id: z.string(),
  ...
  highlights: z.string().max(2e3, "tooLong")
});
var skillGroupSchema = z.object({
  id: z.string(),
...
function getT(locale, messages) {
  const msgs = messages != null ? messages : getMessages(locale);
  return (ns, key) => {
    var _a;
    const nsObj = msgs[ns];
...
function SummarySection({ data, s, t }) {
  ...
  return /* @__PURE__ */ jsxs(View, { style: s.section, children: [
    /* @__PURE__ */ jsx(Text, { style: s.sectionTitle, children: t("resume", "profile") }),
    /* @__PURE__ */ jsx(Text, { style: s.summaryText, children: data.summary })
  ] });
}
function ExperienceSection({ data, s, localeTag, presentLabel, t }) {
  ...
  return /* @__PURE__ */ jsxs(View, { style: s.section, children: [
    /* @__PURE__ */ jsx(Text, { style: s.sectionTitle, children: t("resume", "professionalExperience") }),
    data.experience.map((exp) => /* @__PURE__ */ jsxs(View, { style: s.expItem, children: [
      /* @__PURE__ */ jsxs(View, { style: s.expHeader, children: [
        /* @__PURE__ */ jsxs(View, { children: [
          /* @__PURE__ */ jsx(Text, { style: s.expCompany, children: exp.company }),
          /* @__PURE__ */ jsxs(Text, { style: s.expTitle, children: [
            exp.title,
            exp.location ? ` \xB7 ${exp.location}` : ""
          ] })
        ] }),
        /* @__PURE__ */ jsxs(Text, { style: s.expDate, children: [
      ...
      exp.description ? exp.description.split("\n").filter(Boolean).map((line, i) => /* @__PURE__ */ jsxs(View, { style: s.bullet, children: [
        /* @__PURE__ */ jsx(Text, { style: s.bulletDot, children: "\u2022" }),
        /* @__PURE__ */ jsx(Text, { style: s.bulletText, children: line })
      ] }, i)) : null
    ] }, exp.id))
  ] });
}
function EducationSection({ data, s, localeTag, presentLabel, t }) {
  ...
  return /* @__PURE__ */ jsxs(View, { style: s.section, children: [
    /* @__PURE__ */ jsx(Text, { style: s.sectionTitle, children: t("resume", "education") }),
    data.education.map((edu) => /* @__PURE__ */ jsxs(View, { style: { marginBottom: 6 }, children: [
      /* @__PURE__ */ jsxs(
        View,
        {
          style: {
          ...
          children: [
            /* @__PURE__ */ jsxs(View, { children: [
              /* @__PURE__ */ jsx(Text, { style: s.eduSchool, children: edu.school }),
              /* @__PURE__ */ jsxs(Text, { style: s.eduDegree, children: [
      ...
      edu.highlights ? /* @__PURE__ */ jsx(Text, { style: { fontFamily: PDF_FONT, fontSize: 7.5, color: "#6b7280", marginTop: 2, fontStyle: "italic" }, children: edu.highlights }) : null
    ] }, edu.id))
  ] });
}
function SkillsSection({ data, s, t }) {
  ...
  return /* @__PURE__ */ jsxs(View, { style: s.section, children: [
    /* @__PURE__ */ jsx(Text, { style: s.sectionTitle, children: t("resume", "technicalSkills") }),
    data.skillGroups.map((group) => /* @__PURE__ */ jsxs(View, { style: s.skillGroupRow, children: [
      group.category ? /* @__PURE__ */ jsx(Text, { style: s.skillCategory, children: group.category }) : null,
      /* @__PURE__ */ jsx(View, { style: s.skillsRow, children: group.skills.map((skill, i) => /* @__PURE__ */ jsx(Text, { style: s.skillTag, children: skill }, i)) })
    ] }, group.id))
  ] });
}
function ProjectsSection({ data, s, localeTag, presentLabel, t }) {
  ...
  return /* @__PURE__ */ jsxs(View, { style: s.section, children: [
    /* @__PURE__ */ jsx(Text, { style: s.sectionTitle, children: t("resume", "projects") }),
    data.projects.map((proj, i) => /* @__PURE__ */ jsxs(View, { style: [s.expItem, i > 0 ? { marginTop: 8 } : {}], children: [
      /* @__PURE__ */ jsxs(View, { style: s.expHeader, children: [
        /* @__PURE__ */ jsxs(View, { children: [
          /* @__PURE__ */ jsx(Text, { style: s.expCompany, children: proj.name }),
          proj.technologies.length > 0 ? /* @__PURE__ */ jsx(Text, { style: s.expTitle, children: proj.technologies.join(" \xB7 ") }) : null,
          proj.url ? /* @__PURE__ */ jsx(Text, { style: [s.expTitle, { color: "#9ca3af" }], children: proj.url }) : null
        ] }),
        /* @__PURE__ */ jsxs(Text, { style: s.expDate, children: [
      ...
      proj.description ? /* @__PURE__ */ jsx(Text, { style: s.bulletText, children: proj.description }) : null
    ] }, proj.id))
  ] });
}
function ResumePDFDocument({ resume, locale = "en", messages }) {
  ...
  const headerBlock = !hasSidebar ? /* @__PURE__ */ jsxs(
    View,
    {
      style: [
        s.header,
      ...
      children: [
        data.photo && tmpl.photoPosition !== "top-right" ? /* @__PURE__ */ jsx(
          Image,
          {
            src: data.photo,
        ...
        /* @__PURE__ */ jsxs(
          View,
          {
            ...
            children: [
              /* @__PURE__ */ jsx(Text, { style: s.name, children: data.fullName }),
              data.headline ? /* @__PURE__ */ jsx(Text, { style: s.headline, children: data.headline }) : null,
              contactParts.length > 0 && /* @__PURE__ */ jsx(View, { style: s.contactRow, children: contactParts.map((c, i) => /* @__PURE__ */ jsx(Text, { style: s.contactText, children: c }, i)) })
            ]
          }
        ),
        data.photo && tmpl.photoPosition === "top-right" ? /* @__PURE__ */ jsx(
  ...
  const sectionsBlock = order.map((sectionId) => {
    if (sectionId === "summary")
      return /* @__PURE__ */ jsx(SummarySection, __spreadValues({}, sectionProps), sectionId);
    if (sectionId === "experience")
      return /* @__PURE__ */ jsx(ExperienceSection, __spreadValues({}, sectionProps), sectionId);
    if (sectionId === "education")
      return /* @__PURE__ */ jsx(EducationSection, __spreadValues({}, sectionProps), sectionId);
    if (sectionId === "skills" && !hasSidebar)
      return /* @__PURE__ */ jsx(SkillsSection, __spreadValues({}, sectionProps), sectionId);
    if (sectionId === "projects")
      return /* @__PURE__ */ jsx(ProjectsSection, __spreadValues({}, sectionProps), sectionId);
    return null;
  });
  if (hasSidebar) {
    return /* @__PURE__ */ jsx(Document, { children: /* @__PURE__ */ jsxs(
      Page,
      {
        size: "A4",
        style: [
        ...
        children: [
          /* @__PURE__ */ jsxs(
            View,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx(View, { style: { marginTop: 10, gap: 2 }, children: [
                  data.contact.location,
                  data.contact.email,
                  data.contact.phone,
                  data.contact.linkedin,
                  data.contact.website
                ].filter(Boolean).map((item, i) => /* @__PURE__ */ jsx(
                  Text,
                  {
                    style: {
                      fontFamily: PDF_FONT,
                ...
                data.skillGroups.length > 0 && /* @__PURE__ */ jsxs(View, { style: { marginTop: 12, width: "100%" }, children: [
                  /* @__PURE__ */ jsx(
                    Text,
                    {
                      style: {
                  ...
                  data.skillGroups.map((group, gi) => /* @__PURE__ */ jsxs(View, { style: { marginBottom: 4, width: "100%" }, children: [
                    ...
                    group.skills.map((skill, i) => /* @__PURE__ */ jsx(
                      Text,
                      {
                        style: {
                          fontFamily: PDF_FONT,
          ...
          /* @__PURE__ */ jsx(View, { style: { flex: 1, paddingHorizontal: 24, paddingVertical: 40 }, children: sectionsBlock })
        ]
      }
    ) });
  }
